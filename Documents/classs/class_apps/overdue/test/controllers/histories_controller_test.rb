...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { author: @history.author, name: @history.name, user_id: @history.user_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { author: @history.author, name: @history.name, user_id: @history.user_id } }
